...
# Table of Contents
### 1. [How does Docker work?](#work)
### 2. [How do Docker images interact with the host?](#interact)
### 3. [How are Docker images compromised?](#compromise)
### 4. [Best practices for secure Docker images](#best)
...
# 2. How do Docker images interact with the host?
...
What does the Linux kernel have to do with Docker?
...
# 3. How are Docker images compromised?
...
# 4. Best practices for secure Docker images
...
Use this list to ensure all possible precautions are in place to harden your Docker image:
